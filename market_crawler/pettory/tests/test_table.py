...
from market_crawler.pettory.app import PlaywrightBrowser, extract_table, visit_link
...
async def test_table(browser_headed: PlaywrightBrowser):
    urls = {
        ...
        "https://pettory.com/product/detail.html?product_no=11363&cate_no=4&display_group=1",
    }
