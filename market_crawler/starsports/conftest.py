...
from market_crawler.starsports import config
...
async def browser():
    ...
    login_info = LoginInfo(
        ...
        user_id=config.ID,
        password=config.PW,
        user_id_query="#idForm",
        password_query="#pwForm",
        login_button_query="div.section-login1 > div:nth-child(1) > div > form > input",
    )
