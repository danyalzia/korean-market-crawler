...
from market_crawler.funnydome import config
from market_crawler.funnydome.data import FunnydomeCrawlData
...
async def extract_data(
    ...
    match R3:
        case Ok(table):
            price2, message1, message2, delivery_fee = table
        case Err(err):
...
async def extract_product_name(document: Document):
    query = "#contents > div.xans-product-detail > div.detailArea > div.infoArea > h3"
    return (
...
async def extract_table(document: Document | PlaywrightPage):
    message1 = message2 = delivery_fee = ""
    price2 = 0
    ...
    return price2, message1, message2, delivery_fee
