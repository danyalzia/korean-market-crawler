...
LOGIN_URL: Final[str] = "http://mscoop.co.kr/site/estore/mscoop1/index.php?CID=snsLogin"
ID: Final[str] = "ID"
PW: Final[str] = "PW"
...
DEFAULT_RATE_LIMIT: Final[int] = 4
...
START_CATEGORY: Final[str] = "기능식품"
END_CATEGORY: Final[str] = "홈쇼핑상품"
START_PAGE: Final[int] = 1

SITENAME: Final[str] = "mscoop"
