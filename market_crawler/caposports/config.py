...
LOGIN_URL: Final[str] = "http://www.caposports.co.kr/main/login.html?redirect=0"
ID: Final[str] = "ID"
PW: Final[str] = "PW"
...
START_CATEGORY: Final[str] = "신발"
END_CATEGORY: Final[str] = "여성"
START_PAGE: Final[int] = 1

SITENAME: Final[str] = "caposports"
