...
LOGIN_URL: Final[str] = "http://mongtang.co.kr/shop/member/login.php"
ID: Final[str] = "ID"
PW: Final[str] = "PW"
...
START_CATEGORY: Final[str] = "Seat Cushion"
END_CATEGORY: Final[str] = "Car wash products filters air freshener"
START_PAGE: Final[int] = 1

SITENAME: Final[str] = "blackrhino"
