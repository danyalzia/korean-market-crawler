...
LOGIN_URL: Final[str] = "https://www.1020bag.com/member/login.php"
ID: Final[str] = "ID"
PW: Final[str] = "PW"
...
START_CATEGORY: Final[str] = "여성가방>여성백팩>정장"
END_CATEGORY: Final[str] = "식자재>튀김류>튀김기타"
START_PAGE: Final[int] = 1

SITENAME: Final[str] = "tentwentybag"
