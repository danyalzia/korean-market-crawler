...
from market_crawler.sinsunhi.app import PlaywrightBrowser, extract_html, visit_link
...
async def test_images(browser_headed: PlaywrightBrowser):
    urls = {
        ...
        "https://www.sinsunhi.com/products/13503",
        "https://www.sinsunhi.com/products/10814",
    }
...
async def extract(url: str, browser: PlaywrightBrowser):
    ...
    images = await extract_html(page, url, "", "")
    print(f"{images = }")
