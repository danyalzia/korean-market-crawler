...
from market_crawler.hituzen.app import PlaywrightBrowser, extract_images, visit_link
...
async def test_images(browser: PlaywrightBrowser):
    urls = {
        ...
        "http://hituzen0598.cafe24.com/product/detail.html?product_no=19&cate_no=25&display_group=1",
    }
