...
LOGIN_URL: Final[str] = (
    "https://www.kiwra.co.kr/intro/member.php?returnUrl=%2Fmain%2Findex.php"
)
ID: Final[str] = "ID"
PW: Final[str] = "PW"
...
START_CATEGORY: Final[str] = "민물낚시>찌멈춤고무"
END_CATEGORY: Final[str] = "겨울용품"
START_PAGE: Final[int] = 1

SITENAME: Final[str] = "kiwra"
