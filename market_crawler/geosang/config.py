...
LOGIN_URL: Final[str] = "https://www.geosangkorea.com/shop/main/intro.php"
ID: Final[str] = "ID"
PW: Final[str] = "PW"
...
START_CATEGORY: Final[str] = "바다낚시>바다낚시대"
END_CATEGORY: Final[str] = "직배전용관"
START_PAGE: Final[int] = 1

SITENAME: Final[str] = "geosang"
