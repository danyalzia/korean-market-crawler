...
LOGIN_URL: Final[str] = "https://www.ldsb2bmall.com/shop/member/login.php"
ID: Final[str] = "ID"
PW: Final[str] = "PW"
...
START_CATEGORY: Final[str] = "자켓_겨울 자켓"
END_CATEGORY: Final[str] = "한정판매"
START_PAGE: Final[int] = 1

SITENAME: Final[str] = "landas"
