...
from market_crawler.danharoo.app import PlaywrightBrowser, extract_html, visit_link
...
async def test_images(browser: PlaywrightBrowser):
    urls = {
        ...
        "http://danharoo.com/product/detail.html?product_no=50630&cate_no=43&display_group=1",
    }

    urls = list(urls)
    shuffle(urls)
    tasks = (extract(url, browser) for url in urls[:5])
