...
LOGIN_URL: Final[str] = "http://danharoo.com/member/login.html"
ID: Final[str] = "ID"
PW: Final[str] = "PW"
...
MIN_PRODUCTS_CHUNK_SIZE: Final[int] = 50
...
START_CATEGORY: Final[str] = "당일출고"
END_CATEGORY: Final[str] = "당일출고"
START_PAGE: Final[int] = 1

SITENAME: Final[str] = "danharoo"
