...
LOGIN_URL: Final[str] = "https://www.ssakasports.co.kr/member/login"
ID: Final[str] = "ID"
PW: Final[str] = "PW"
...
MAX_PRODUCTS_CHUNK_SIZE: Final[int] = 30

USE_CATEGORY_SAVE_STATES: Final[bool] = True
USE_PRODUCT_SAVE_STATES: Final[bool] = True
SAVE_HTML: Final[bool] = True

START_CATEGORY: Final[str] = "축구>축구화"
END_CATEGORY: Final[str] = "스포츠/골프"
START_PAGE: Final[int] = 1

SITENAME: Final[str] = "ssakasports"
