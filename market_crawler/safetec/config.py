...
LOGIN_URL: Final[str] = "http://safetecb2b.co.kr/member/login.html"
ID: Final[str] = "ID"
PW: Final[str] = "PW"
...
START_CATEGORY: Final[str] = "코로나 자가진단키트"
END_CATEGORY: Final[str] = "와이드앵글 골프용품"
START_PAGE: Final[int] = 1

SITENAME: Final[str] = "safetec"
