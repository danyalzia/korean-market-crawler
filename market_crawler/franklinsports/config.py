...
LOGIN_URL: Final[str] = "http://franklinsports.co.kr/member/login.html"
ID: Final[str] = "ID"
PW: Final[str] = "PW"
...
START_CATEGORY: Final[str] = "선오더"
END_CATEGORY: Final[str] = "브랜드 인솔"
START_PAGE: Final[int] = 1

SITENAME: Final[str] = "franklinsports"
