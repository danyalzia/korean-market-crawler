...
LOGIN_URL: Final[str] = "https://www.밸리스도매.com/member/login.html?"
ID: Final[str] = "ID"
PW: Final[str] = "PW"
...
START_CATEGORY: Final[str] = "일반 도매 회원>사료>강아지"
END_CATEGORY: Final[str] = "일반 도매 회원>용품"
START_PAGE: Final[int] = 1

SITENAME: Final[str] = "ballys"
