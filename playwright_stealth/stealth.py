...
def stealth_sync(page: SyncPage, config: StealthConfig | None = None):
...
async def stealth_async(page: AsyncPage, config: StealthConfig | None = None):
